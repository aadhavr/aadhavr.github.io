...
subtitle: "A gravity analysis of post-colonial social connectivity to estimate imperial legacies."
author:
  - name: Aadhav Rajesh
...
That is a sharp contrast with trade. Head, Mayer and Ries (2010) show that trade between former colonies and their colonizers declines substantially in the decades after independence.[^hmr] Trade forgot about the empire, but it seems friendship, so far, has not.
